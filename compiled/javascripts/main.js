...
write_projects_to_dom = function(buckets) {
  var all_projects, col, columns, i, num_columns, project, projects, s, section, sections, _i, _j, _len, _ref;
  all_projects = $("<div>");
  sections = (function() {
    var _results;
    _results = [];
  ...
  for (_i = 0, _len = sections.length; _i < _len; _i++) {
    ...
    for (i = _j = 0, _ref = projects.length; 0 <= _ref ? _j <= _ref : _j >= _ref; i = 0 <= _ref ? ++_j : --_j) {
      project = projects[i];
